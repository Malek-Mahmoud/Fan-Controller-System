...
#define MOTOR_PINX_ID PIN1_ID
#define MOTOR_PINY_ID PIN2_ID
/*******************************************************************************
 *                             Types Declaration                               *
 *******************************************************************************/
typedef enum
...
typedef enum
{
	SPEED_0,SPEED_25=25,SPEED_50=50,SPEED_75=75,SPEED_100=100
}Dc_motorSpeedType;
 ...
 */
void DcMotor_Rotate(Dc_motorStateType state,uint8 speed);
